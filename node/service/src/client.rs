...
/// A set of APIs that substrate-like runtimes must implement.
///
...
where
	<Self as sp_api::ApiExt<Block>>::StateBackend:
...
#[cfg(feature = "with-devnet-runtime")]
impl From<Arc<crate::FullClient<devnet_runtime::RuntimeApi, crate::DevnetExecutor>>> for Client {
	fn from(
		client: Arc<crate::FullClient<devnet_runtime::RuntimeApi, crate::DevnetExecutor>>,
	) -> Self {
		Self::Devnet(client)
	}
}
